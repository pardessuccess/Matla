...
package com.sensomedi.matla.ble
...
object ConnectionManager {
    ...
    private fun signalEndOfOperation() {
        println("End of $pendingOperation")
    ...
    private val callback = object : BluetoothGattCallback() {
        ...
        override fun onCharacteristicWrite(
            ...
            with(characteristic) {
                when (status) {
                    BluetoothGatt.GATT_SUCCESS -> {
                        println("Wrote to characteristic $uuid | value: ${value.toHexString()}")
                        listeners.forEach {
                    ...
                    BluetoothGatt.GATT_WRITE_NOT_PERMITTED -> {
                        ...
                        println("Characteristic write failed for $uuid, error: $status")
                    }
                }
            }
        ...
        override fun onCharacteristicChanged(
            ...
            with(characteristic) {
                println("Characteristic $uuid changed | value: ${value.toHexString()}")
